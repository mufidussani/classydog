...
const Navbar = () => {
  ...
  return (
    <div className="text-white fixed z-[100] flex h-[70px] w-full justify-between bg-ogreen">
      ...
      >
        ...
        <ul className="z-50 mx-0 mt-16 flex h-full w-full flex-col bg-ogreen sm:fixed sm:items-center sm:justify-evenly sm:text-3xl xl:hidden mobile:fixed mobile:items-center mobile:gap-10 mobile:text-3xl text-white-normal">
          <li className="active">
            <Link
              to=""
              onClick={() => {
