...
const CJenis = () => {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col items-center gap-12 px-6 pt-8 pb-12 mt-16 sm:gap-8 sm:pt-16 sm:pb-24 bg-gradient-to-r from-green-500 to-lgreen">
